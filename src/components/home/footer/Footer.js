...
const Footer = (props) => {
  ...
  <div className="footer">
    <Container>
      <Row lg="2">
        <Col>
        <p>Find an issue? Have a suggestion? </p>
        <p>{github} <a alt="Github Repository" href="https://github.com/sdoxsee/env-gen">Pull Requests</a> are welcome.</p>
          ...
          <p>
            ...
            <a href="https://github.com/sdoxsee">{github}</a>
          </div>
          </p>
          <h3>Disclaimer</h3>
